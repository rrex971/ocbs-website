...
const Info = () => {
  return (
    <div className='bg-logan-500 bg-info-bg bg-cover min-h-screen'>
      <div className="aboutcontainer mx-auto px-6 md:px-24 lg:px-48 flex flex-col lg:flex-row justify-between items-center">
        {/* Text Section */}
        <div className='abouttext flex flex-col text-center lg:text-left'>
          ...
          <div className='font-body font-medium text-logan-800 text-sm sm:text-lg text-left leading-loose max-w-full md:max-w-2xl pr-0 lg:pr-10'>
