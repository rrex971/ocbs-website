    ...
    <nav className="bg-logan-500 bg-cover p-5 rounded-b-xl">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <ul className="flex md:space-x-8 space-x-3 justify-between items-center text-sm md:text-lg font-head text-logan-800">
          ...
          <li><NavLink to="/mappools" className={({ isActive }) => (isActive ? "text-banana-mania-100 opacity-100" : "navbar-link opacity-50 hover:opacity-100 transition-opacity duration-300 transition-colors duration-300 ease-in-out")}>Mappools</NavLink></li>
