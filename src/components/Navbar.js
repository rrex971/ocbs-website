  ...
  return (
    <nav className="bg-logan-500 bg-cover p-5 rounded-b-xl">
      <div className="container mx-auto flex justify-between items-center">
        <div className="text-banana-mania-100 text-2xl font-head"><NavLink to="/" className="navbar-link hover:text-white-50 transition-colors duration-300 ease-in-out">o!CBS</NavLink></div>
